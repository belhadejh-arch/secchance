    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-6 sm:space-y-8 font-sans" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-1 border-b border-slate-200/60 pb-3 sm:pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">
              نتمنى لك يوماً مفعماً بالصحة والأمل • حماية وسرية تامة 100%
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 self-end sm:self-auto">
          <div className="hidden md:flex items-center gap-2 bg-emerald-50 text-emerald-800 border border-emerald-200/80 px-3 py-1 rounded-full text-xs font-bold">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            <span>المختصون في الخدمة الآن</span>
          </div>
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed max-w-2xl">
              استشارات نفسية متخصصة، حماية وتكييف قانوني دون عقوبة، وإحالات فورية لمراكز إزالة السموم والجمعيات الشريكة عبر 58 ولاية جزائرية.
            </p>
          ...
          <div className="lg:col-span-4 bg-white/80 backdrop-blur-md rounded-2xl p-4 sm:p-5 border border-blue-100/80 shadow-xs space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 text-center">
              <div className="bg-blue-50/70 p-2.5 rounded-xl border border-blue-100">
                <span className="block text-lg sm:text-xl font-black text-[#1565C0] font-mono">140+</span>
                <span className="text-[10px] sm:text-[11px] text-slate-600 font-medium">حالة متكفل بها</span>
              </div>
              <div className="bg-emerald-50/70 p-2.5 rounded-xl border border-emerald-100">
                <span className="block text-lg sm:text-xl font-black text-[#2E7D32] font-mono">53</span>
                <span className="text-[10px] sm:text-[11px] text-slate-600 font-medium">مركز علاج وطني</span>
              </div>
              <div className="bg-purple-50/70 p-2.5 rounded-xl border border-purple-100">
                <span className="block text-lg sm:text-xl font-black text-purple-700 font-mono">24</span>
                <span className="text-[10px] sm:text-[11px] text-slate-600 font-medium">أخصائي ومحامٍ</span>
              </div>
              <div className="bg-amber-50/70 p-2.5 rounded-xl border border-amber-100">
                <span className="block text-lg sm:text-xl font-black text-amber-700 font-mono">24/7</span>
                <span className="text-[10px] sm:text-[11px] text-slate-600 font-medium">خط طوارئ دائم</span>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-3 sm:space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
          ...
          >
            ...
            <div>
              <span className="text-xs sm:text-sm font-bold text-slate-800 leading-tight block">مراكز العلاج (53)</span>
              <span className="text-[11px] text-slate-400 hidden sm:block mt-0.5">دليل المراكز عبر 58 ولاية</span>
            </div>
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="p-5 sm:p-6 rounded-3xl bg-gradient-to-r from-[#091E3A] to-[#1565C0] text-white shadow-md flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="space-y-1.5 max-w-lg">
              ...
              <p className="text-xs text-blue-100 leading-relaxed">
                محادثة سرية ومجهولة الهوية بنسبة 100% تساعدك في تقييم الأعراض والتوجيه لأقرب مركز علاج مرخص أو مختص مناوب.
              </p>
            </div>
            <button
              onClick={onOpenAiTriage}
          ...
          <div className="p-5 rounded-3xl bg-red-50/90 border border-red-200/90 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <span className="text-base sm:text-lg font-black text-slate-900">الرقم الأخضر المجاني: 1099</span>
                <p className="text-[11px] text-slate-600">متوفر 24 ساعة / 7 أيام لكل ولايات الوطن مع استجابة فورية</p>
              </div>
            </div>
            <button
              onClick={() => onNavigateTo('emergency')}
        ...
        {/* Left side on Desktop (5 cols): Specialists On Duty */}
        <div className="lg:col-span-5 space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-sm sm:text-base font-black text-slate-900">المختصون المتاحون للاستشارة</h3>
          ...
          <div className="space-y-3">
            {/* Doctor Card */}
            <div className="p-4 bg-white rounded-2xl border border-slate-200/80 shadow-xs hover:border-blue-200 transition-all flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-xl bg-blue-100 text-[#1565C0] flex items-center justify-center font-bold text-xs shrink-0">
                  ف.ز
                </div>
                <div>
            ...
            {/* Lawyer Card */}
            <div className="p-4 bg-white rounded-2xl border border-slate-200/80 shadow-xs hover:border-amber-200 transition-all flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-xl bg-amber-100 text-amber-700 flex items-center justify-center font-bold text-xs shrink-0">
                  م.ع
                </div>
                <div>
                  <h4 className="font-bold text-xs sm:text-sm text-slate-900">أ. محمد العربي</h4>
                  <p className="text-[11px] text-slate-500">محامٍ معتمد • حماية وتكييف قانوني للمتعافين</p>
                </div>
              </div>
              <button
                onClick={() => onNavigateTo('appointments')}
